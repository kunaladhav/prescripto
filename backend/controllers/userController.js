...
const registerUser = async (req, res) => {
  try {
    ...
    if (!name || !email || !password) {
      return res.json({
        success: false,
        message: "Please fill in Missing Details",
      });
    }

    // Check Password Length is 8 or above
...
// API for the User Appointments idsplay on the my-appointments page in frontend
...
// API for the User to cancel the Appointment
...
const cancelAppointment = async (req, res) => {
  try {
    ...
    // To verify the Correct User's Appointment
    ...
    // Open the Cancelled Slot of the Doctor for other Patients
